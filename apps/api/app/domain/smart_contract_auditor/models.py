...
class AgenticSmartContractAuditorSession(Base):
    __tablename__ = "smart_contract_auditor_sessions"
...
class AgenticSmartContractAuditorItem(Base):
    __tablename__ = "smart_contract_auditor_items"

    id = Column(String, primary_key=True, index=True)
    session_id = Column(String, ForeignKey("smart_contract_auditor_sessions.id"))
